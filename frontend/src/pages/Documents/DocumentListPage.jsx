        ...
        <div className="flex items-center justify-between mb-10">
          ...
          {documents.length > 0 && (
            <Button onClick={() => setIsUploadModalOpen(true)}>
              <Plus strokeWidth={2.5} className="w-4 h-5" />
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  value={uploadTitle}
                  required
                  className="w-full h-12 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-300 focus:bg-white hover:bg-white focus:shadow-lg focus:shadow-emerald-500/10"
          ...
          <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-900/20 p-8">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={deleting}
                className="flex-1 h-11 px-4 bg-linear-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-red-500/25 disabled:opcaity-50 disabled:cursor-not-allowed active:scale-[0.98]"
              >
                {deleting ? (
                  <span className="flex items-center justify-center gap-2">
                    <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
