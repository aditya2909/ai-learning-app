      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-slate-100 to to-slate-200 flex items-center justify-center">
              ...
              {[
                ...
                .map((activity, index) => (
                  <div key={activity.id || index} className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
                    ...
                    {activity.link && (
                      <a href={activity.link} className="ml-4 px-4 py-2 text-xs font-semibold text-emerald-600 rounded-lg hover:bg-emerald-50 hover:text-emerald-700 transition-all duration-200 whitespace-nowrap">
                        View
                      </a>
                    )}
                  </div>
