    ...
    <div className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10 flex flex-col justify-between" onClick={handleStudyNow}>
      <div className="space-y-4">
        ...
        {totalCards > 0 && (
          <div className="space-y-2">
            ...
            <div className="relative h-2 bg-slate-100 rounded-full overflow-hidem">
      ...
      <div className="mt-6 pt-4 border-t border-slate-100">
        ...
        >
          ...
          <div className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover/btn:translate-x-full transition-transform ease-out duration-700"  />
        </button>
      </div>
    </div>
  );
