...
const FlashcardManager = ({ documentId }) => {
  ...
  const handleToggleStart = async (cardId) => {
    try {
    ...
    return (
      <div className="space-y-8">
        ...
        <button
          ...
          className="group inline-flex gap-2 items-center text-sm font-medium text-slate-600 hover:text-emerald-600 transition-colors duration-200 "
        >
          <ArrowLeft
            strokeWidth={2}
        ...
        <div className="flex flex-col items-center space-y-8">
          <div className="w-full max-w-2xl">
            <Flashcard
              ...
              onToggleStar={handleToggleStart}
            />
          </div>
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transtition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100"
            >
              <ChevronLeft
                strokeWidth={2.5}
                className="w-4 h-4 group-hover:-transalte-x-0.5 transition-transform duration-200"
              />
              Previous
            </button>
      ...
      >
        <div className="space-y-6">
          <p className="text-sm text-slate-600">
            ...
            cannot be undone and all cards will be permanently deleted.
          </p>
