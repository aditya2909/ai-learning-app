      ...
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ node, ...props }) => (
            <blockquote className="border-l-4 border-neutral-500 pl-4 italic text-neutral-600 my-4" {...props} />
          ),
          code: ({ node, inline, className, children, ...props }) => {
            ...
            return !inline && match ? (
              ...
              <code className="bg-neutral-100 p-1 rounded font-mono text-sm">{children}</code>
            );
          },
