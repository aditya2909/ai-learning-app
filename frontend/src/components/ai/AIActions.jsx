    ...
    <>
            ...
            <form onSubmit={handleExplainConcept}>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-md focus:shadow-slate-500/10"
      ...
      >
        <div className="max-h-[60vh] overflow-y-auto prose prose-sm max-w-none prose-slate">
          <MardownRenderer content={modalContent} />
        </div>
      </Modal>
    </>
  );
